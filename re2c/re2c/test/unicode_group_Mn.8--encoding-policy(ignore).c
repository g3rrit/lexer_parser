/* Generated by re2c */
#line 1 "unicode_group_Mn.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Mn.8--encoding-policy(ignore).re"
	{ goto Mn; }
#line 490 "unicode_group_Mn.8--encoding-policy(ignore).c"
yy26:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x96:
...
#line 14 "unicode_group_Mn.8--encoding-policy(ignore).re"
