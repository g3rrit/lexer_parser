/* Generated by re2c */
#line 1 "unicode_group_Cf.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Cf.8--encoding-policy(ignore).re"
	{ goto Cf; }
#line 99 "unicode_group_Cf.8--encoding-policy(ignore).c"
yy15:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xB4:
...
#line 14 "unicode_group_Cf.8--encoding-policy(ignore).re"
