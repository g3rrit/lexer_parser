/* Generated by re2c */
#line 1 "unicode_group_Mc.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Mc.8--encoding-policy(ignore).re"
	{ goto Mc; }
#line 576 "unicode_group_Mc.8--encoding-policy(ignore).c"
yy54:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 14 "unicode_group_Mc.8--encoding-policy(ignore).re"
