/* Generated by re2c */
#line 1 "unicode_group_So.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_So.8--encoding-policy(ignore).re"
	{ goto So; }
#line 193 "unicode_group_So.8--encoding-policy(ignore).c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xBA:	goto yy17;
...
#line 14 "unicode_group_So.8--encoding-policy(ignore).re"
