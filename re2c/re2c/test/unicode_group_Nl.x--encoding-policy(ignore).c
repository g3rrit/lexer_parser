/* Generated by re2c */
#line 1 "unicode_group_Nl.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 12 "unicode_group_Nl.x--encoding-policy(ignore).re"
	{ goto Nl; }
#line 55 "unicode_group_Nl.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF41) {
...
#line 14 "unicode_group_Nl.x--encoding-policy(ignore).re"
