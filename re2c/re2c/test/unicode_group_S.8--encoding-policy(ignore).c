/* Generated by re2c */
#line 1 "unicode_group_S.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_S.8--encoding-policy(ignore).re"
	{ goto S; }
#line 57 "unicode_group_S.8--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0xA2:
...
#line 14 "unicode_group_S.8--encoding-policy(ignore).re"
