/* Generated by re2c */
#line 1 "unicode_group_Lm.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Lm.8--encoding-policy(ignore).re"
	{ goto Lm; }
#line 186 "unicode_group_Lm.8--encoding-policy(ignore).c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9A:
...
#line 14 "unicode_group_Lm.8--encoding-policy(ignore).re"
