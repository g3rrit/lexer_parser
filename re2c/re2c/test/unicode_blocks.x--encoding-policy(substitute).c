/* Generated by re2c */
#line 1 "unicode_blocks.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#	define YYCURSOR start
	...
	#line 338 "unicode_blocks.x--encoding-policy(substitute).re"
