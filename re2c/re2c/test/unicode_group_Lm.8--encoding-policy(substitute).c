/* Generated by re2c */
#line 1 "unicode_group_Lm.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Lm.8--encoding-policy(substitute).re"
	{ goto Lm; }
#line 186 "unicode_group_Lm.8--encoding-policy(substitute).c"
yy19:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9A:
...
#line 14 "unicode_group_Lm.8--encoding-policy(substitute).re"
