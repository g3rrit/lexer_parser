/* Generated by re2c */
#line 1 "unicode_group_Lu.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Lu.8--encoding-policy(substitute).re"
	{ goto Lu; }
#line 77 "unicode_group_Lu.8--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x80:
...
#line 14 "unicode_group_Lu.8--encoding-policy(substitute).re"
...
int main ()
{
	YYCTYPE * buffer_Lu = new YYCTYPE [5748];
	unsigned int buffer_len = encode_utf8 (chars_Lu, sizeof (chars_Lu) / sizeof (unsigned int), buffer_Lu);
