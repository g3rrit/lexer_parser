/* Generated by re2c */
#line 1 "unicode_group_N.x--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf16.h"
...
#line 12 "unicode_group_N.x--encoding-policy(substitute).re"
	{ goto N; }
#line 252 "unicode_group_N.x--encoding-policy(substitute).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF1F) {
		if (yych <= 0xDD3F) {
...
#line 14 "unicode_group_N.x--encoding-policy(substitute).re"
