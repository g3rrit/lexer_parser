/* Generated by re2c */
#line 1 "unicode_group_Mn.8--encoding-policy(substitute).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Mn.8--encoding-policy(substitute).re"
	{ goto Mn; }
#line 490 "unicode_group_Mn.8--encoding-policy(substitute).c"
yy26:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x96:
...
#line 14 "unicode_group_Mn.8--encoding-policy(substitute).re"
