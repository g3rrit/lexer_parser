/* Generated by re2c */
#line 1 "unicode_group_Me.8--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf8.h"
...
#line 12 "unicode_group_Me.8--encoding-policy(ignore).re"
	{ goto Me; }
#line 52 "unicode_group_Me.8--encoding-policy(ignore).c"
yy9:
	yych = *++YYCURSOR;
	switch (yych) {
	case 0x9D:
...
#line 14 "unicode_group_Me.8--encoding-policy(ignore).re"
