/* Generated by re2c */
#line 1 "unicode_group_Po.x--encoding-policy(ignore).re"
#include <stdio.h>
#include "utf16.h"
...
#line 12 "unicode_group_Po.x--encoding-policy(ignore).re"
	{ goto Po; }
#line 364 "unicode_group_Po.x--encoding-policy(ignore).c"
yy6:
	yych = *++YYCURSOR;
	if (yych <= 0xDF9E) {
...
#line 14 "unicode_group_Po.x--encoding-policy(ignore).re"
